                    ...
                    <div className="collapse navbar-collapse justify-content-end" id="menu">
                        <ul className="navbar-nav">
                            <li className="nav-item ">
                                <div className="nav-link nav-btn"><a className={"header-a " + (selected === "" ? "header-active" : "")} href="#home" >Home</a></div>
                            ...
                            <li className="nav-item">
                                <div className="nav-link nav-btn"><a className={"header-a " + (selected === "#about" ? "header-active" : "")} href="#about" >About</a></div>
                                {/* <div className="nav-link header-a">
                            ...
                            <li className="nav-item">
                                <div className="nav-link nav-btn"><a className={"header-a " + (selected === "#service" ? "header-active" : "")} href="#service" >Service</a></div>
                                {/* <div className="nav-link header-a">
                            ...
                            <li className="nav-item">
                                <div className="nav-link nav-btn"><a className={"header-a " + (selected === "#team" ? "header-active" : "")} href="#team" >Team</a></div>
                                {/* <div className="nav-link header-a">
                            ...
                            <li className="nav-item">
                                <div className="nav-link nav-btn"><a className={"header-a " + (selected === "#testimonial" ? "header-active" : "")} href="#testimonial" >Testimonial</a></div>
                                {/* <div className="nav-link header-a">
                            ...
                            <li className="nav-item">
                                <div className="nav-link nav-btn"><a className={"header-a " + (selected === "#blog" ? "header-active" : "")} href="#blog" >Blog</a></div>
                                {/* <div className="nav-link header-a">
                            ...
                            <li className="nav-item">
                                <div className="nav-link nav-btn"><a className={"header-a " + (selected === "#contact" ? "header-active" : " ")} href="#contact">Contact</a></div>
                                {/* <div className="nav-link header-a">
            ...
            return (
                <div className={"navbar navbar-expand-lg custome-toggler navbar-light navigation-wrapper master-padding " + this.state.scrollclass}>
                    ...
                    <div className="collapse navbar-collapse justify-content-end" id="menu">
                        <ul className="navbar-nav">
                            <li className="nav-item ">
                                <div className="nav-link nav-btn"><a className={"header-a " + (selected === "#home" ? "header-active" : "")} href="#home" >Home</a></div>
                                {/* <div className="nav-link header-a">
                            <Link activeClass=" header-active" to="home" spy={true} smooth={true} duration={500}>
                                Home
                            </Link>
